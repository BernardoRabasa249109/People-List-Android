package com.berny.peopleapp.feature_users.presentation.edit
...
import com.berny.peopleapp.R
import com.berny.peopleapp.feature_users.presentation.edit.components.UserInputText
...
@Composable
fun EditContent(name: String, lastName: String, age: String, onEvent: (EditEvent) -> Unit) {
